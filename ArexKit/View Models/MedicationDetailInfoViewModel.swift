...
public class MedicationDetailInfoViewModel {
    ...
    public lazy var updateName: Action<String?, Void, NoError> = {
        let lens = MedicationDetailInfoViewModelLenses.medication >>> MedicationLenses.name
    ...
    public lazy var updateDosesLeft: Action<String?, Void, NoError> = {
        let lens = transform(MedicationDetailInfoViewModelLenses.medication >>> MedicationLenses.dosesLeft, flip(self.dosesLeftValueTransformer))
    ...
    public lazy var updateStrength: Action<String?, Void, NoError> = {
        let lens = MedicationDetailInfoViewModelLenses.medication >>> MedicationLenses.strength
...
private struct MedicationDetailInfoViewModelLenses {
    static let medication = Lens(
        get: { $0.medication },
        set: { (inout viewModel: MedicationDetailInfoViewModel, medication) in viewModel.medication = medication }
    )
}
